...
export default function PaymentPlan(email) {
    ...
    return (
        <div className="container-fluid overflow-hidden mt-5 mb-0 min-vh-100">
            <h4 className="text-center mx-5 texto-grande-1 fw-normal my-5 fs-1 lato-regular">Selecciona la opción que mejor se adapte a tus necesidades:</h4>
            <div className="row d-flex align-items-start justify-content-center my-auto gap-5 mt-4 mb-2">
                ...
                <div className="text-center col-md-3 p-4 bg-grey">
                    ...
                    <button type="button" className="px-5 btn btn-dark btn-lg text-white border border-dark rounded-3 fw-light" onClick={handleClickOneCategory}>Selecciona</button>
                </div>
                <div className="text-center col-md-3 p-4 bg-grey">
                    ...
                    <button type="button" className="px-5 btn btn-dark btn-lg text-white border border-dark rounded-3 fw-light" onClick={handleClickTwoCategories}>Selecciona</button>
                </div>
            </div>
        </div >
    );
